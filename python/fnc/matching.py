...
##-----------------------------------------------------------------------------
##  Function threshold=0.38
##-----------------------------------------------------------------------------
def matching(template_extr, mask_extr, temp_dir, threshold=0.4):
	"""
	Description:
	...
	if len(ind_thres)==0:
		...
		filenames = [filenames[idx] for idx in ind_sort]
		return list(zip(filenames,hm_dists))
